		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3 text-base">
				...
				<div className="flex justify-start space-x-3">
					...
					<a href="https://www.facebook.com/1visionagency" target='_blank' rel="noreferrer" className="flex items-center p-1 scale-125 hover:scale-150 hover:transition-all">
					...
					<a rel="noopener noreferrer" href='https://www.youtube.com/@1visionagency' target='_blank' className="flex items-center p-1 scale:75 hover:scale-125 hover:transition-all">
					<img src={Youtube} width='32' className='mt-3'/>
					</a>
						</Tippy>

						<Tippy content='Instagram'>
					<a rel="noopener noreferrer" href="https://www.instagram.com/1visionagency/" target="_blank" className="flex items-center p-1 scale-125 hover:scale-150 hover:transition-all">
