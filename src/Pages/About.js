...
export default function Experience() {
  return (
    <>
    <h2 className='container abbg-[#146994] text-white mx-auto text-4xl font-medium text-center mt-16 mb-6 py-3 rounded-lg' id="education-haeding">About Us</h2>    
    <div className='mx-6 my-12 text-justify'>
    ...
    <h2 className='container abbg-[#146994] text-white mx-auto text-4xl font-medium text-center mt-16 mb-6 py-3 rounded-lg' id="education-haeding">Our Goal</h2>    
