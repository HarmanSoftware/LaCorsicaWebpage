...
export default function Home() {
    ...
    <>
      ...
      <div className='scale-95 hover:scale-100 ease-in-out duration-500'>
          ...
          <div className='px-2 text-justify'>Enssuring the up to date of social media page, making sure that the page is doing well and developing a content sharing calendar.</div>
      </div>
      <div className='scale-95 hover:scale-100 ease-in-out duration-500'>
          ...
          <div className='px-2 text-justify'>Providing the creative photography and photo editing for local and international brands
      ...
      <div className='scale-95 hover:scale-100 ease-in-out duration-500'>
          ...
          <div className='px-2 text-justify'>Every successful company needs a modern and stylish website, by collabrating with my team of developers we’re able to deliver the required website</div>
      </div>
      <div className='scale-95 hover:scale-100 ease-in-out duration-500'>
          ...
          <div className='px-2 text-justify'>If in case your businesses needs beautiful mobile application for sure Lens Agency can make and Provide reliable and stylish mobile apps</div>
      </div>
      <div className='scale-95 hover:scale-100 ease-in-out duration-500'>
          <div className='text-lg bg-[#146994] text-white hover:bg-[#146994] p-4 rounded-md drop-shadow-sm' id="web-skill-5">
            Branding & Design
          </div>
          <div className='px-2 text-justify'>My team of creative directors are able to turn your product and introduce it to the world through amazing graphic visuals</div>
      </div>
      <div className='scale-95 hover:scale-100 ease-in-out duration-500'>
         <div className='text-lg bg-[#146994] text-white hover:bg-[#146994] p-4 rounded-md drop-shadow-sm' id="web-skill-6">Content Writing
      </div>
      <div className='px-2 text-justify'>Content writing and marketing plan as well as trainings for start-up marketing companies staffs</div>
      </div>
      <br></br>
       </div>       
      </div>
