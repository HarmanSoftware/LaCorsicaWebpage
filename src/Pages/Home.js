...
export default function Home() {
    return (
      <AnimatedPages>
        <div className='relative'>         
            <div className='absolute z-10 flex flex-col items-center justify-center h-full w-full text-white font-semibold lg:text-6xl md:text-5xl -mt-2' id='hi-text'>Hi - Think Diffirent!              
            <Link to="service">
            <button className='mt-2' id="cssbuttons-io"><span> Service <img src={RightArrow} alt='RightArrow img' className='w-6 h-6 mx-2'/> </span></button>  
            </Link>            
            </div>
  ...
  <div className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 my-12' id="aboutme-div">       
       ...
       <h2 className='container mx-auto text-center font-semibold text-4xl mt-16 mb-16'>Best Service Is To Think Like A Costumer</h2>
       ...
       <h2 className='container mx-auto text-center font-semibold text-4xl mt-16 mb-16'>Make Your Work Dream Reallity!</h2>
    </div>
      </AnimatedPages>
  )
}